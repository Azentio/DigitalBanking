...
public class ExcelDataUpdate {
	public static void main(String args[])
	{
		...
		ExcelData exelDataForGeneralLedger = new ExcelData(testDataPath, "CSM_TransferAccountTestData", "DataSet ID");
		ExcelData executionSheet = new ExcelData(testDataPath, "TransferAccount_Execution", "TestCaseID");
		Map<String,String> testData= new HashMap<>();
		String filePath_Two = System.getProperty("user.dir") + "\\TransferAccountExcelFile\\TRANSFERACC_Two.xlsx";
		String filePath_One = System.getProperty("user.dir") + "\\TransferAccountExcelFile\\TRANSFERACC.xlsx";
		ExcelReader excelReader= new ExcelReader(filePath_Two);
		ExcelReader excelReader_One= new ExcelReader(filePath_One);
...
//		exelDataForGeneralLedger.updateTestData("TSA_002_01", "ExecuteYes/No", "Yes");
		...
		executionSheet.updateTestData("TA_070", "ExecuteYes/No", "No");
		executionSheet.updateTestData("TA_070_01", "ExecuteYes/No", "No");
