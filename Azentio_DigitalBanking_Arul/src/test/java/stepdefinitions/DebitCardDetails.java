...
public class DebitCardDetails {
	...
	@Given("User_074 enters the CorporateUser in the login page for omni_web_portal")
	public void user_074enters_the_CorporateUser_in_the_login_page_for_omni_web_portal() {
	...
	@Given("User_074 enters the CorporatePass in the login page for omni_web_portal")
	public void user_074enters_the_CorporatePass_in_the_login_page_for_omni_web_portal() {
	...
	@And("User_074 loads the test datasetup for the test case id AT_DCD_001")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_001() {
	...
	@And("User_074 loads the test datasetup for the test case id AT_DCD_005")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_005() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_005");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}

	@And("User_074 loads the test datasetup for the test case id AT_DCD_006")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_006() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_005");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_021")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_021() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_021");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_022")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_022() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_022");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_023")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_023() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_023");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_024")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_024() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_024");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_024_01")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_024_01() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_024");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_PCR_001")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_PCR_001() {
		executionTestData = DataReader.executionTestData.get("AT_PCR_001");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_PCR_002")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_PCR_002() {
		executionTestData = DataReader.executionTestData.get("AT_PCR_002");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_PCR_004")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_PCR_004() {
		executionTestData = DataReader.executionTestData.get("AT_PCR_004");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_PCR_005")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_PCR_005() {
		executionTestData = DataReader.executionTestData.get("AT_PCR_005");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_PCR_003")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_PCR_003() {
		executionTestData = DataReader.executionTestData.get("AT_PCR_003");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("user_074 click on the Cards screen in the homepage")
	public void user_074_click_on_the_cards_screen_in_the_homepage() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("OmniScreen_Login").get("Cards_OmniHomeScreen"), false);
	}

	@Given("User_074 Verify the My Cards section is avaible or not")
	public void user_074verify_the_my_cards_request_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("OmniScreen_Login").get("MyCards_Cards_OmniHomeScreen"));

	}

	@Given("User_074 Verify the Debit card request section is avaible or not")
	public void user_074verify_the_debit_card_request_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Debit_Card_Request"));
	}

	@Given("User_074 Verify the credit card request section is avaible or not")
	public void user_074verify_the_credit_card_request_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Credit_Card_Request"));
	}

	@Given("User_074 Verify the prepaid card request section is avaible or not")
	public void user_074verify_the_prepaid_card_request_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Prepaid_card_request"));
	}

	@Given("User_074 Verify the prepaid card recharge section is avaible or not")
	public void user_074verify_the_prepaid_card_recharge_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Prepaid_card_recharge"));
	}

	@Given("User_074 Verify the credit card settlement section is avaible or not")
	public void user_074verify_the_credit_card_settlement_section_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Credit_card_settlement"));
	}

	@Given("User_074 Verify the Debit Card Segment is visible in My Cards Screen")
	public void user_074verify_the_debit_card_segment_is_visible_in_my_cards_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("MyCards_Debit_Cards1"));
	}

	@Given("User_074 Verify the Credit Card Segment is visible in My Cards Screen")
	public void user_074verify_the_credit_card_segment_is_visible_in_my_cards_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("MyCards_Credit_Cards1"));
	}

	@Given("User_074 Verify the Prepaid Card Segment is visible in My Cards Screen")
	public void user_074verify_the_prepaid_card_segment_is_visible_in_my_cards_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("MyCards_Prepaid_Cards1"));
	}

	@Given("User_074 Verify the Type of debit card is showing in Debit Card Segment")
	public void user_074verify_the_type_of_debit_card_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Debit_Cards_Type"));
	}

	@Given("User_074 Verify the Currency Name is showing in Debit Card Segment")
	public void user_074verify_the_currency_name_is_showing_in_debit_card_segment() {
	...
	@Given("User_074 Verify the Card Holder Name is showing in Debit Card Segment")
	public void user_074verify_the_card_holder_name_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Card_Holder_Name"));
	}
	@Given("User_074 Verify the Status of the Card is showing in Debit Card Segment")
	public void user_074verify_the_status_of_the_card_is_showing_in_debit_card_segment() {
	...
	@Given("User_074 Verify the Edit Icon is showing in Debit Card Segment")
	public void user_074verify_the_edit_icon_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("EditIconVisible_debitDetails"));
	}

	@Given("User_074 Verify the Show more is showing in Debit Card Segment")
	public void user_074verify_the_show_more_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ShowMore"));
	}

	@Given("User_074 Click on the edit button in Debit card details")
	public void user_074click_on_the_edit_button_in_debit_card_details() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("EditIconClick_DebitDetails"), false);
	}
	
	@Given("User_074 Verify the Card change name button is visible")
	public void user_074verify_the_card_change_name_button_is_visible() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ChangeCardNameVisible_debitDetails"));
	}

	@Given("User_074 Verify the Save button is visible After clicking edit")
	public void user_074verify_the_save_button_is_visible_after_clicking_edit() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Save_DebitDetails"));
	}

	@Given("User_074 Click on the Show More button below the card details")
	public void user_074click_on_the_show_more_button_below_the_card_details() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("ShowMoreClick_DebitDetails"), true);
	}

	@Given("User_074 Verify the Primary Account is showing in Debit Card Segment")
	public void user_074verify_the_primary_account_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("PrimaryAccount_DebitDetails"));
	}

	@Given("User_074 Verify the Expiry Date is showing in Debit Card Segment")
	public void user_074verify_the_expiry_date_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ExpiryDate_DebitDetails"));
	}

	@Given("User_074 Verify the Applicant Address is showing in Debit Card Segment")
	public void user_074verify_the_applicant_address_is_showing_in_debit_card_segment() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ApplicantAddress_debitDetails"));
	}

	@Given("User_074 Verify the Pin Change is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_pin_change_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("PinChangeVisi_DebitDetails"));
	}

	@Given("User_074 Verify the Pin Reset is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_pin_reset_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("PinResetVisi_DebitDetails"));
	}

	@Given("User_074 Verify the Deactivate is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_deactivate_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DeactivateVisi_DebitDetails"));

	}

	@Given("User_074 Verify the Limit Update is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_limit_update_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("LimitVisi_DebitDetails"));
	}

	@Given("User_074 Verify the Upgrade Card is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_upgrade_card_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("UpgradeCardVisi_Debitdetails"));

	}

	@Given("User_074 Verify the Replace Card is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_replace_card_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ReplaceCardVisi_DebitDetails"));

	}

	@Given("User_074 Verify the Block is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_block_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("BlockVisi_DebitDetails"));

	}

	@Given("User_074 Verify the Add on Card is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_add_on_card_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("AddOnCardVisi_DebitDetails"));

	}

	@Given("User_074 Verify the prepaid request is showing in Debit Card ShowMore Screen")
	public void user_074verify_the_prepaid_request_is_showing_in_debit_card_show_more_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("PrepaidVisi_DebitDetails"));
	}

	@Given("User_074 Click on the Pin Change In Debit Card Details")
	public void user_074click_on_the_pin_change_in_debit_card_details() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("PinChangeVisi_DebitDetails"), false);
	}

	@Given("User_074 Verify the old pin is showing in Debit Card PinChange Screen")
	public void user_074verify_the_old_pin_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("OldPinVisi_DebitDetails"));
	}

	@Given("User_074 Verify the new pin is showing in Debit Card PinChange Screen")
	public void user_074verify_the_new_pin_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("NewPinVisi_DebitDetails"));
	}

	@Given("User_074 Verify the Confirm new pin is showing in Debit Card PinChange Screen")
	public void user_074verify_the_confirm_new_pin_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ConfirmPinVisi_DebitDetails"));
	}

	@Given("User_074 Verify the Cancel is showing in Debit Card PinChange Screen")
	public void user_074verify_the_cancel_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Cancel_DebitDetails"));
	}
	@Given("User_074 Verify the Previous is showing in Debit Card PinChange Screen")
	public void user_074verify_the_Previous_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Previous_DebitDetails"));
	}

	@Given("User_074 Verify the Submit is showing in Debit Card PinChange Screen")
	public void user_074verify_the_submit_is_showing_in_debit_card_pin_change_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("SubmitVisi_DebitDetails"));
	}

	@Given("User_074 Enter old pin For Update new in Debit Card PinChange Screen")
	public void user_074enter_old_pin_for_update_new_in_debit_card_pin_change_screen() {
	...
	@Given("User_074 Enter New pin For Update new in Debit Card PinChange Screen")
	public void user_074enter_new_pin_for_update_new_in_debit_card_pin_change_screen() {
		us.enterData(driver, DataReader.locatorsMap.get("Cards").get("NewPinVisi_DebitDetails"), testData.get("NewPin"),
				false);
	}

	@Given("User_074 Enter Confirm New_pin For Update new in Debit Card PinChange Screen")
	public void user_074enter_confirm_new_pin_for_update_new_in_debit_card_pin_change_screen() throws Exception {
	...
	@Given("User_074 Click on the Submit button in Beneficiary")
	public void user_074click_on_the_submit_button_in_Beneficiary() throws Throwable {
...
//		}
	...
	@Given("User_074 Click on the Submit button in debit Card PinChange Screen")
	public void user_074click_on_the_submit_button_in_debit_card_pin_change_screen() throws Throwable {
		for (int i = 0; i <= 500; i++) {
			try {
	...
	@Given("User_074 Click on the Pin Reset in Debit Card ShowMore Screen")
	public void User_074_Click_on_the_Pin_Reset_in_Debit_Card_ShowMore_Screen() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("PinResetVisi_DebitDetails"),false);
	}
	@Given("User_074 Verify the Request Successfully Popup in Pinchange Screen")
	public void user_074verify_the_request_successfully_popup_in_pinchange_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("OmniScreen_L").get("SuccessPopUP"));
	}
	@Given("User_074 Verify the Deactivate Request Successfully Popup in Pinchange Screen")
	public void user_074verify_Deactivate_the_request_successfully_popup_in_pinchange_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("OmniScreen_L").get("DeactivatePopUP"));
	}
	@Given("User_074 Verify the Draft Saved Successfully After click Submit")
	public void User_074_Verify_the_Draft_Saved_Successfully_After_click_Submit() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("OmniScreen_L").get("DraftSuccessPopUP"));
	}
	
	@Given("User_074 Click on the Deactivate Below the card Details")
	public void User_074_Click_on_the_Deactivate_Below_the_card_Details() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("DeactivateVisi_DebitDetails"),false);
	}
	//At_DCD_007
	@And("User_074 loads the test datasetup for the test case id AT_DCD_007")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_007() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_007");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("User_074 Click on the Limit Update For Field Verification")
	public void user_074click_on_the_limit_update_for_field_verification() throws InterruptedException {
		Thread.sleep(5000);
	...
	@Given("User_074 Verify the CurrencyPOS field Available or Not in POS Limit Update")
	public void user_074verify_the_currency_pos_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("POS_Currency_DebitDetails"));
	}
	@Given("User_074 Check the Currencypos Field is in read only Mode Below POS Limit Update")
	public void user_074check_the_currencypos_field_is_in_read_only_mode_below_pos_limit_update() {
	...
	@Given("User_074 Verify the Current POS Limit Field Available or Not in POS Limit Update")
	public void user_074verify_the_current_pos_limit_field_available_or_not_in_pos_limit_update() {
	 us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Current_pos_limit_DebitDetails"));
	}
	@Given("User_074 Check the Current POS Limit Field is in read only Mode POS Limit Update")
	public void user074_check_the_current_pos_limit_field_is_in_read_only_mode_pos_limit_update() {
...
//        }
	...
	@Given("User_074 Verify the Periodicity Field Available or Not in POS Limit Update")
	public void user_074_verify_the_periodicity_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("POS_Periodicity"));
	}

	@Given("User_074 Check the Periodicity Field is in read only Mode POS Limit Update")
	public void user_074_check_the_periodicity_field_is_in_read_only_mode_pos_limit_update() {
	...
	@Given("User_074 Verify the Utilized Currency Field Available or Not in POS Limit Update")
	public void user_074_verify_the_utilized_currency_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("UtilizedCurrency_DebitDetails"));
	}

	@Given("User_074 Check the Utilized Currency Field is in read only Mode POS Limit Update")
	public void user_074_check_the_utilized_currency_field_is_in_read_only_mode_pos_limit_update() {
	...
	@Given("User_074 Verify the Utilized POS Limit Field Available or Not in POS Limit Update")
	public void user_074_verify_the_utilized_pos_limit_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("UtilizedPOSLIMIT_debitdetails"));
	}

	@Given("User_074 Check the Utilized POS Limit Field is in read only Mode POS Limit Update")
	public void user_074_check_the_utilized_pos_limit_field_is_in_read_only_mode_pos_limit_update() {
...
//        }
	...
	@Given("User_074 Verify the Remaining Currency Field Available or Not in POS Limit Update")
	public void user_074_verify_the_remaining_currency_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("RemainingCurrency_DebitDetails"));
	}

	@Given("User_074 Check the Remaining Currency Field is in read only Mode POS Limit Update")
	public void user_074_check_the_remaining_currency_field_is_in_read_only_mode_pos_limit_update() {
	...
	@Given("User_074 Verify the Requested POS Limit Field Available or Not in POS Limit Update")
	public void user_074_verify_the_requested_pos_limit_field_available_or_not_in_pos_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("RequestPOSLimit_DebitDetails"));
	}

	@Given("User_074 Check the Requested POS Limit Field is in Editable POS Limit Update")
	public void user_074_check_the_requested_pos_limit_field_is_in_editable_pos_limit_update() {
		us.enterData(driver, DataReader.locatorsMap.get("Cards").get("RequestPOSLimit_DebitDetails"),
				testData.get("RequestPOS"), false);
	}
	//AT_DCD_008
	@And("User_074 loads the test datasetup for the test case id AT_DCD_008")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_008() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_008");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("User_074 Verify the Currency field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_currency_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("CurrencywdCode_DebitDetails"));
	}

	@Given("User_074 Check the Currency field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_currency_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Current Withdrawal Limit Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_current_withdrawal_limit_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("CurrencyWDLimit_DebitDetails"));
	}

	@Given("User_074 Check the Current Withdrawal Limit is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_current_withdrawal_limit_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Periodicity Wd field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_periodicity_wd_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("WdPeriodicity_DebitDetails"));
	}

	@Given("User_074 Check the Periodicity Wd field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_periodicity_wd_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Utilized Currency WD field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_utilized_currency_wd_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("UtilizedCurrencyWD_DebitDetails"));
	}

	@Given("User_074 Check the Utilized Currency WD field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_utilized_currency_wd_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Utilized Withdrawal Limit field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_utilized_withdrawal_limit_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("UtilizedCurrencyLimit_DebitDetails"));
	}
	@Given("User_074 Check the Utilized Withdrawal Limit field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_utilized_withdrawal_limit_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Remaining Currency WD field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_remaining_currency_wd_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("RemainingCurrencyWd_DebitDetails"));
	}
	@Given("User_074 Check the Remaining Currency WD field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_remaining_currency_wd_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Remaining Withdrawal Limit field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_remaining_withdrawal_limit_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("RemainingWdLimit_DebitDetails"));
	}
	@Given("User_074 Check the Remaining Withdrawal Limit field is in Read Only Withdrawal Limit Update")
	public void user_074_check_the_remaining_withdrawal_limit_field_is_in_read_only_withdrawal_limit_update() {
	...
	@Given("User_074 Verify the Requested Withdrawal field Available or Not in Withdrawal Limit Update")
	public void user_074_verify_the_requested_withdrawal_field_available_or_not_in_withdrawal_limit_update() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("RequestedWDLimitDebitDetails"));
	}

	@Given("User_074 Check the Requested Withdrawal field is in Editable Withdrawal Limit Update")
	public void user_074_check_the_requested_withdrawal_field_is_in_editable_withdrawal_limit_update() {
		us.enterData(driver, DataReader.locatorsMap.get("Cards").get("RequestedWDLimitDebitDetails"),
				testData.get("RequestWithdrwal"),false);
	}
//AT_DCD_009
	@Given("User_074 Enter Data On Requested POS Limit field below POS Limit Update")
	public void user_074enter_data_on_requested_pos_limit_field_below_pos_limit_update() {
		us.enterDataAndTab(driver, DataReader.locatorsMap.get("Cards").get("RequestPOSLimit_DebitDetails"),
				testData.get("RequestPOS"), false);
	}

	@Given("User_074 Enter Data On Requested Withdrawal field below Withdrawal Limit Update")
	public void user_074enter_data_on_requested_withdrawal_field_below_withdrawal_limit_update() {
...
//		withdrawal.sendKeys(Keys.TAB);
	...
	@Given("User_074 Verify the Next button in the limit Update Screen")
	public void user_074_verify_the_next_button_in_the_limit_update_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Next_DebitDetails"));
	}

	@Given("User_074 Verify the Cancel button in the limit Update Screen")
	public void user_074_verify_the_cancel_button_in_the_limit_update_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Cancel_DebitDetailsLUS"));
	}

	@Given("User_074 Verify the Save button in the limit Update Screen")
	public void user_074_verify_the_save_button_in_the_limit_update_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Save_DebitDetailsLUS"));
	}

	@Given("User_074 Click On the Save button For Save the Draft in limit Update Screen")
	public void user_074_click_on_the_save_button_for_save_the_draft_in_limit_update_screen() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("Save_DebitDetailsLUS"),false);
	}

	@Given("User_074 Verify the draft title field After clicking save button")
	public void user_074_verify_the_draft_title_field_after_clicking_save_button() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DraftTitle_DebitDetails"));
	}

	@Given("User_074 Verify the Cancel button in draft Saving Screen")
	public void user_074_verify_the_cancel_button_in_draft_saving_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Draft_Cancel_PCR"));
	}

	@Given("User_074 Verify the Submit button in draft Saving Screen")
	public void user_074_verify_the_submit_button_in_draft_saving_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Draft_Submit_PCR"));
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_011")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_011() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_011");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_012")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_012() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_012");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}

	@Given("User_074 Click on the Next button in limit Update Screen")
	public void user_074_click_on_the_next_button_in_limit_update_screen() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("Next_DebitDetails"),false);
	}
	@Given("User_074 Click on the Next button in limit Update Screen with Wait")
	public void user_074_click_on_the_next_button_in_limit_update_screen_with_Wait() throws InterruptedException {
		Thread.sleep(20000);
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("Next_DebitDetails"),false);
	}
	
	
	@Given("User_074 Click on the Next button in limit Update Screen for pos screen")
	public void user_074_click_on_the_next_button_in_limit_update_screenfor_pos_screen() throws InterruptedException {
		Thread.sleep(10000);
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("Next_DebitDetails"),false);	
		}
	@Given("User_074 Verify the I Agree is showing in Debit Card PinChange Screen")
	public void User_074_Verify_the_I_Agree_is_showing_in_Debit_Card_PinChangeScreen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("OmniScreen_L").get("IAgreeTnC_ScheduledTransfer"));	
	}
	
	@Given("User_074 Click on the I agree Check Box in Screen2")
	public void user_074_click_on_the_i_agree_check_box_in_screen2() {
		try {
	...
	@Given("User_074 Click on the Save button in Screen2")
	public void user_074_click_on_the_save_button_in_screen2() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("Save_DebitDetailsLUS"),false);
	}

	@Given("User_074 Enter Draft Name for save the Debit Detail request")
	public void user_074_enter_draft_name_for_save_the_debit_detail_request() {
	...
	@Given("User_074 Enter Draft Name for save the Debit Detail request With CardName")
	public void user_074_enter_draft_name_for_save_the_debit_detail_request_With_CardName() {
	...
	@Given("User_074 Click on sumbit button Save the Data")
	public void user_074_click_on_sumbit_button_save_the_data() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("DraftSubmit_debitDetails"),false);
	}

	@Given("User_074 Click on the To Do Screen For check the Saved Draft")
	public void user_074_click_on_the_to_do_screen_for_check_the_saved_draft() {
		us.clickOnElement(driver, DataReader.locatorsMap.get("OmniScreen_Login").get("TODO_HomeScreen1"),false);
	}

	@Given("User_074 Click on the saved Draft data for verification")
	public void user_074_click_on_the_saved_draft_data_for_verification() {
	...
	// Non Duplicate Steps 
	@And("User_074 loads the test datasetup for the test case id AT_DCD_013")
	public void User_074loads_the_test_datasetup_for_the_test_case_id_AT_DCD_013() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_013");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_014")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_014() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_014");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("User_074 Click on the Previous button in Debit Card details Screen")
	public void user_074_Click_on_the_Previous_button_in_Debit_Card_details_Screen() {
		us.clickOnElement(driver, 
				DataReader.locatorsMap.get("Cards").get("Previous_DebitDetails"),false);
		}
	@Given("User_074 Verify the Screen2 with the help of Card information Tab")
	public void User_074_Verify_the_Screen2_with_the_help_of_Card_information_Tab() {
		us.elementIsVisible(driver,DataReader.locatorsMap.get("Cards").get("CardLimitInformation_DebitDetails"));
		}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_015")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_015() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_015");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@And("User_074 loads the test datasetup for the test case id AT_DCD_016")
	public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_016() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_016");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("User_074 loads the test datasetup for the test case id AT_DCD_017")
	public void user_074_loads_the_test_datasetup_for_the_test_case_id_at_dcd_017() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_017");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}
	@Given("User_074 loads the test datasetup for the test case id AT_DCD_018")
	public void user_074_loads_the_test_datasetup_for_the_test_case_id_at_dcd_018() {
		executionTestData = DataReader.executionTestData.get("AT_DCD_018");
		System.out.println(executionTestData);
		testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
	}

@Given("User_074 loads the test datasetup for the test case id AT_DCD_019")
public void user_074_loads_the_test_datasetup_for_the_test_case_id_at_dcd_019() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_019");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@Given("User_074 loads the test datasetup for the test case id AT_DCD_020")
public void user_074_loads_the_test_datasetup_for_the_test_case_id_at_dcd_020() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_020");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}

	@Given("User_074 Verify the Draft title is avaible or not")
	public void user_074_verify_the_draft_title_is_avaible_or_not() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DraftTitle_DebitDetails"));
	}

	@Given("User_074 Verify the Cancel button the Draft details screen")
	public void user_074verify_the_cancel_button_the_draft_details_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Cancel_DebitDetails"));
	}

	@Given("User_074 Verify the submit button the draft details screen")
	public void user_074_verify_the_submit_button_the_draft_details_screen() {
		us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("SubmitVisi_DebitDetails"));
	}
	@Given("User_074 Click on the cancel button in the draft screen")
	public void User_074_Click_on_the_cancel_button_in_the_draft_screen() {
...
//razia	
	...
	public void user074_NavigatesToTheOmni_Corporate_Web_Portal() {
    ...
    public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_CCS_002() {
	...
	public void user_074_enters_the_corpusername_in_the_login_page_for_omni_corp_portal() {
	...
	public void user_074_enters_the_Corppassword_in_the_login_page_for_omni_corp_portal() {
...
public void user_074_click_credit_card_settlement_submenu_under_cards_menu() {
	try {
...
public void user_074_click_mycredit_card_settlement_submenu_under_cards_menu() {
	try {
...
public void user_074_click_mycredit_card_settlement() {
	us.clickOnElementNoWait(driver, DataReader.locatorsMap.get("Cards").get("Validate_MycreditCardSettlement"),20, false);
	}
@And("user_612 Click the  CardMenu under omni_corp_portal")
public void user_074_click_the_cardmenu_under_omni_corp_portal( ) {
	try {
		us.clickOnElementNoWait(driver, 
...
public void user_074_click_on_the_selection_of_credit_card_in_credit_card_settlement_screen() {
...
public void user_074_select_the_credit_card_in_the_dropdown_credit_card_in_credit_card_settlement_screen() {
...
public void user_074_click_on_the_settlement_account_dropdown_in_credit_card_settlement_screen() {
...
public void user_074_select_the_settlement_account_in_credit_card_settlement_screen() {
...
public void user_074_click_on_the_currency_and_enter_currency_name_in_search_box() {
...
public void user_074_select_the_currency_name_in_the_dropdown() {
...
public void user_074_enter_the_transction_amount_in_credit_card_settlement_screen() {
...
@Given("User_074 verify the screen3 into screen2 by clicking previous")
public void user_074_verify_the_screen3_into_screen2_by_clicking_previous() {
  us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Screen2_Verification"));
}

@Given("User_074 verify the screen2 into screen1 by clicking previous")
public void user_074_verify_the_screen2_into_screen1_by_clicking_previous() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("POS_Currency_DebitDetails"));
}
@Given("User_074 validate the Current POS Limit in Debit Details Screen3")
public void user_074_validate_the_current_pos_limit_in_debit_details_screen3() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_CurrentPOSLimit_s3"));
}
@Given("User_074 validate the Utilized POS Limit in Debit Details Screen3")
public void user_074_validate_the_utilized_pos_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_UtilizedPOSlimit_s3"));
  
}

@Given("User_074 validate the Remaining POS Limit in Debit Details Screen3")
public void user_074_validate_the_remaining_pos_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_RemainingPOSLimit_s3"));
    
}
@Given("User_074 validate the Requested POS Limit in Debit Details Screen3")
public void user_074_validate_the_requested_pos_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_RequestedPOSLimit_s3"));
    
}

@Given("User_074 validate the Current withdrawal Limit in Debit Details Screen3")
public void user_074_validate_the_current_withdrawal_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_CurrentwithdrawalLimit_s3"));
    
}
@Given("User_074 validate the Periodicity2 in Debit Details Screen3")
public void user_074_validate_the_periodicity2_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_Periodicity2_s3"));
    }

@Given("User_074 validate the Utilized withdrawal Limit in Debit Details Screen3")
public void user_074_validate_the_utilized_withdrawal_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_UtilizedwithdrawalLimit_s3"));
    }

@Given("User_074 validate the Remaining withdrawal Limit in Debit Details Screen3")
public void user_074_validate_the_remaining_withdrawal_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_RemainingwithdrawalLimit_s3"));
    }

@Given("User_074 validate the Requested withdrawal Limit in Debit Details Screen3")
public void user_074_validate_the_requested_withdrawal_limit_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_RequestedwithdrawalLimit_s3"));
    }

@Given("User_074 validate the I Agree Terms and condition in Debit Details Screen3")
public void user_074_validate_the_i_agree_terms_and_condition_in_debit_details_screen3() {
    us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_I_agree_S3"));
    }	
@Given("User_074 Click on the block card below the show more button")
public void user_074_click_on_the_block_card_below_the_show_more_button() {
	 us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("BlockVisi_DebitDetails"),false);
}

@Given("User_074 Validate the Card information section in block card Screen")
public void user_074_validate_the_card_information_section_in_block_card_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Card_Information_DCD"));
}

@Given("User_074 Validate the Card Block options section in block card Screen")
public void user_074_validate_the_card_block_options_section_in_block_card_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("CardBlockOptions_DCD"));
}

@Given("User_074 Validate the block card reason below the Card block options")
public void user_074_validate_the_block_card_reason_below_the_card_block_options() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_CardBlockReason"));
}

@Given("User_074 Validate the Toggle button below the Card block options")
public void user_074_validate_the_toggle_button_below_the_card_block_options() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("ToggleButton_click"),false);
}

@Given("User_074 click on the block card reason in the block card Screen")
public void user_074_click_on_the_block_card_reason_in_the_block_card_screen() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("DCD_CardBlockReason"),false);
}

@Given("User_074 Select the option below the block card Screen")
public void user_074_select_the_option_below_the_block_card_screen() throws InterruptedException { 
...
@Given("User_074 Click on the toggle button re issue card in block card Screen")
public void user_074_click_on_the_toggle_button_re_issue_card_in_block_card_screen() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("ToggleButton_clickJS"),true);
}
@Given("User_074 Validate the terms and conditions page")
public void User_074_Validate_the_terms_and_conditions_page() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("TermsConditionPage_DCD"));
}
@Given("User_074 validate the I Agree Terms and condition in Block Card Screen")
public void User_074_validate_the_I_Agree_Terms_and_condition_in_Block_Card_Screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("IagreeConditions"));
}
@Given("User_074 verify the screen2 into screen1 by clicking previous in block card screen")
public void user_074_verify_the_screen2_into_screen1_by_clicking_previous_in_block_card_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Card_Information_DCD"));
}
@Given("User_074 Validate the Card block reason in Block Card screen3")
public void user_074_validate_the_card_block_reason_in_block_card_screen3() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_CardBlockReason"));
	}
@Given("User_074 Validate the Re issue Card in Block Card screen3")
public void user_074_validate_the_re_issue_card_in_block_card_screen3() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_ReissueCard_S3"));
}

@Given("User_074 Validate the I agree terms in Block Card screen3")
public void user_074_validate_the_i_agree_terms_in_block_card_screen3() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_IAGree_S3"));
}
@Given("User_074 Click on the Prepaid Card Request below the card details")
public void User_074_Click_on_the_Prepaid_Card_Request_below_the_card_details() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("DCD_PrepaidCardRequest"),false);
}
@Given("User_074 Verify the Reference Card is showing in Prepaid Card Request Screen")
public void user_074_verify_the_reference_card_is_showing_in_prepaid_card_request_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ClickReferenceCard_Dropdown"));
}

@Given("User_074 Click on the reference card drop down in Prepaid Card Request Screen")
public void user_074_click_on_the_reference_card_drop_down_in_prepaid_card_request_screen() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("ClickReferenceCard_Dropdown"),false);
}

@Given("User_074 Select reference card in Prepaid Card Request Screen")
public void user_074_select_reference_card_in_prepaid_card_request_screen() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("SelectCard_PCR"),false);
}
@Given("User_074 Click the Back Arrow button in the 1st Screen of prepaid card request")
public void User_074_Click_the_Cancel_button_in_the_1st_Screen_of_prepaid_card_request() {
...
@Given("User_074 Verify the progress screen was closed in prepaid card request")
public void  User_074_Verify_the_progress_screen_was_closed_in_prepaid_card_request() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ClickReferenceCard_Dropdown"));
}

@Given("User_074 Verify the Cancel button in draft Saving ScreenWO index")
public void user_074_verify_the_cancel_button_in_draft_saving_screenWO_index() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Draft_ForWO_Cancel"));
}
@Given("User_074 Verify the value missing for user does not allow to navigate screen")
public void User_074_Verify_the_value_missing_for_user_does_not_allow_to_navigate_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ValueMissing_forValidation"));
}
@And("User_074 loads the test datasetup for the test case id AT_PCR_006")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_PCR_006() {
	executionTestData = DataReader.executionTestData.get("AT_PCR_006");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_PCR_007")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_PCR_007() {
	executionTestData = DataReader.executionTestData.get("AT_PCR_006");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_PCR_008")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_PCR_008() {
	executionTestData = DataReader.executionTestData.get("AT_PCR_008");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_PCR_009")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_PCR_009() {
	executionTestData = DataReader.executionTestData.get("AT_PCR_009");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_053")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_053() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_053");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_054")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_054() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_054");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_058")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_058() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_058");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_060")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_060() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_060");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_062")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_062() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_062");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_063")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_063() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_062");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_064")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_064() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_062");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_065")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_065() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_062");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_066")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_066() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_062");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_067")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_067() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_067");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_068")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_068() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_067");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_069")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_069() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_070");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@And("User_074 loads the test datasetup for the test case id AT_DCD_070")
public void User_074_loads_the_test_datasetup_for_the_test_case_id_AT_DCD_070() {
	executionTestData = DataReader.executionTestData.get("AT_DCD_070");
	System.out.println(executionTestData);
	testData = DataReader.testDataMap.get("CardsOmni").get(executionTestData);
}
@Given("User_074 Select reference card in Prepaid Card Request Screen for retailUser")
public void user_074_select_reference_card_in_prepaid_card_request_screen_for_retailUser() {
...
@Given("User_074 Verify the reference Card in the summary Screen")
public void user_074_verify_the_reference_card_in_the_summary_screen() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("PCR_Screen3_ReferenceCard"));
   
}
@Given("User_074 Click on the submit in 3st Screen of prepaid card request")
public void User_074_Click_on_the_submit_in_3st_Screen_of_prepaid_card_request() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("DraftSubmit_debitDetails"),false);
}
@Given("User_074 Verify the Currency Name is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_currency_name_is_showing_in_debit_card_segmentof_Retail_User() {
	// us.waitHelper(driver,DataReader.locatorsMap.get("Cards").get("CurrencyName_DebitCardDetails"));
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Oguiya_CurrencyName"));
}
@Given("User_074 Verify the Card Holder Name is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_card_holder_name_is_showing_in_debit_card_segmentof_Retail_User() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("CardHolderName_DebitDetails_retail"));
}
@Given("User_074 Verify the Status of the Card is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_status_of_the_card_is_showing_in_debit_card_segmentof_Retail_User() {
	// String xpath= "//ion-label[contains(text(),+'
	// testData.get("FromAccount1")+"'))]/ancestor::mat-card-header//mat-card-subtitle//ion-label[contains(text(),'Active')]";
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("StatusOfCard_retail"));
}
@Given("User_074 Verify the Edit Icon is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_edit_icon_is_showing_in_debit_card_segment_of_Retail_User() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("EditIcon_debitDetails_Retail"));
}
@Given("User_074 Click on the edit button in Debit card details of Retail User")
public void user_074_click_on_the_edit_button_in_debit_card_detailsof_Retail_User() {
	us.clickOnElement(driver, DataReader.locatorsMap.get("Cards").get("EditIconClick_DebitDetails_Retail"), false);
}
@Given("User_074 Verify the Card change name button is visible of Retail User")
public void user_074_verify_the_card_change_name_button_is_visible_of_Retail_User() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ChangeCardNameVisible_DCD_RT"));
}
@Given("User_074 Click on the Show More button below the card details of Retail User")
public void user_074_click_on_the_show_more_button_below_the_card_details_of_Retail_User() throws Exception {
//	for (int i = 0; i <= 30; i++) {
//		try {
...
@Given("User_074 Verify the Expiry Date is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_expiry_date_is_showing_in_debit_card_segmentof_Retail_User() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("ExpiryDate_retail"));
}
@Given("User_074 Verify the Applicant Address is showing in Debit Card Segment of Retail User")
public void user_074_verify_the_applicant_address_is_showing_in_debit_card_segmentof_Retail_User() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Address_Retail"));
}
@Given("User_074 Verify the Screen2 back into Screen1 in retail Limit Update")
public void User_074_Verify_the_Screen2_back_into_Screen1_in_retail_Limit_Update() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("POS_Currency_DebitDetails"));
	}
@Given("User_074 Verify the Screen3 back into Screen2 in retail Limit Update")
public void User_074_Verify_the_Screen3_back_into_Screen2_in_retail_Limit_Update() {
	try {
		us.clickOnElementNoWait(driver,
				DataReader.locatorsMap.get("OmniScreen_Login").get("IAgreeTnC_ScheduledTransfer"), 30, false);
...
@Given("user_612 click the save button")
...
public void user_612validate_the_i_agree_condition_is_display_or_ot_not_in_screen3( ) {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCD_IAGree_S3"));
}
...
public void user_612verify_screen_is_closed_and_switched_to_screen1( ) {
...
@Given("User_074 Click on the Previous button in Debit Card details Screen With wait")
public void user_074_Click_on_the_Previous_button_in_Debit_Card_details_Screen_With_wait() throws InterruptedException {
	Thread.sleep(5000);
	us.clickOnElement(driver, 
			DataReader.locatorsMap.get("Cards").get("Previous_DebitDetails"),false);
	}
