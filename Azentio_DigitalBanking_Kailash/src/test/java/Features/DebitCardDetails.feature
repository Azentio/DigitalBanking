...
@AT_DCD_017
Scenario: Verify the Draft Details in Screen2 and fields in draft verification
...
@AT_DCD_031
Scenario: Verify That user can Navigate to Add on Card - Debit Cards - Prepaid Card Request
And User_612 loads the test datasetup for the test case id AT_DCD_030
Given user_612 navigates to the omni_corporate_web_portal
And user_612 enters the Corpusername in the login page for omni_corp_portal
And user_612 enters the Corppassword in the login page for omni_corp_portal
...
@AT_DCD_063
Scenario: Verify that Debit Card Details Pin change Screen with all fields given below
...
@AT_DCD_064
Scenario: Verify that Debit Card Details Screen Pin reset functionality
...
@AT_DCD_065
Scenario: Verify that Debit Card Details Screen Deactivate functionality
...
And User_626 Verify the Deactivate is showing in Debit Card ShowMore Screen
And User_626 Click on the Deactivate Below the card Details
And User_626 Verify the Deactivate Request Successfully Popup in Pinchange Screen 
