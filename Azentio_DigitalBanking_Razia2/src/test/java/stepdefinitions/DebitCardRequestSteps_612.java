...
public class DebitCardRequestSteps_612 {
	...
	public void user_enters_the_retailpassword_in_the_login_page_for_omni_corp_portal() {
...
public void user_validate_the_debit_card_request_dropdown( ) {
...
public void user_validate_the_request_branch_dropdown( ) {
...
public void user_validate_the_collect_or_reveiver_details( ) {
...
public void user_validate_the_next_button() {
...
public void user_validate_the_save_button() {
...
public void user_click_the_primary_account_dropdown_button() {
...
public void user_slect_the_account_under_the_primary_account() {
...
public void user_enter_the_card_holder_under_dcr_screen() {
	us.enterData
...
public void user_click_the_card_type_dropdown_dcr_screen( ) {
...
public void user_select_the_cardtype( ) {
...
public void user_enter_draft_title_under_popup( ) {
	us.enterData
...
public void user_click_to_do_button_under_tha_for_omni_corporate_web_portal() {
...
public void user_validate_the_maps_screen( ) {
...
public void user_validate_the_previous_button_in_maps_screen( ) {
...
public void user_validate_the_next_button_in_maps_screen( ) {
...
public void user_validate_the_save_button_in_maps_screen( ) {
...
public void user_click_the_next_button_in_maps_screen( ) {
...
public void user_validate_the_cancel_button_in_screen2( ) {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCR_Cancel"));
    
}

@Given("user_612 validate the submt button in screen2")
public void user_validate_the_submt_button_in_screen2( ) {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("DCR_Sumbit"));
}

@Given("user_612 click submit button in screen2")
public void user_click_submit_button_in_screen2() {
    us.clickOnElementNoWait(driver, DataReader.locatorsMap.get("Cards").get("DCR_Sumbit"), 20, false);
}
...
public void user_validate_screen2_is_displaying_or_not() {
	us.elementIsVisible(driver,DataReader.locatorsMap.get("Cards").get("DCR_Screen2_Maps"));
}

@Given("user_612 Click pevious button in screen2")
public void user_click_pevious_button_in_screen2( ) {
...
public void user_verify_the_previous_button_is_working_and_go_to_homepage() {
	us.elementIsVisible(driver, DataReader.locatorsMap.get("Cards").get("Debit_Card_Request_validate"));
