...
//        Assert.assertTrue(driver.findElement(By.xpath(x)).isDisplayed());
    ...
    public void user_click_the_alertmapping_underintergration_settings() throws InterruptedException {
    	  us.clickOnElement(driver,DataReader.locatorsMap.get("Omni_Admin").get("Parameters_IntergarationSetting_AlerteventMapping"),true);
    	  Thread.sleep(5000);
    ...
    public void user_click_the_reports_mapping_under_intergration_settings() throws InterruptedException {
    ...
    public void user_click_search_button_under_maintenance() {
    ...
    public void user_double_tab_the_exiting_record_under_maintenance() throws Throwable {
    ...
    public void user_click_the_service_code_under_fiancial_service_limit() throws Throwable {
    ...
    public void user_enter_a_value_in_operation_under_service_code() {
    ...
    public void user_click_the_service_code_under_non_fiancial_service_limit() {
    ...
    public void user_click_the_searchbutton_in_service_code_under_non_fiancial_service_limit() throws InterruptedException {
    ...
    public void user_enter_a_value_in_operation_in_service_code_under_non_fiancial_service_limit() throws InterruptedException {
    ...
    public void user_search_the_block_credit_card_field_in_screen_under_alert_mapping() throws InterruptedException {
    	//Thread.sleep(3000);
...
public void user_navigates_to_the_omni_web_portal() {
...
public void user_enters_the_retail_username_in_the_login_page_for_omni_web_portal() {
...
public void user_enters_the_retail_password_in_the_login_page_for_omni_web_portal() {
...
public void user_click_on_the_loggin_button_in_the_login_page_for_omni_web_portal() throws InterruptedException {
...
public void user_click_on_the_force_logout_btn_in_the_login_page_for_omni_web_portal() {
...
public void user_click_on_the_ok_button_for_the_successful_login_page_for_omni_web_portal() {
	try {
		us.clickOnElementNoWait(driver, 
