Feature: Checking the functionalities of CreditCardSettlement  and DebitCardDetails
  ...
  #Feature: Check the funcnality of  DebitCardDetails kailash sprint 13,14
