...
And user enters the username in the login page for omni_corporate_web_portal
And user enters the password in the login page for omni_corporate_web_portal
