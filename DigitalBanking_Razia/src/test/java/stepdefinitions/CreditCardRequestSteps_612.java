...
public void user_612_click_the_drop_down_button_in_card_type_under_card_detail() throws Throwable{
...
try {
		 ...
		 us.clickOnElement(driver,DataReader.locatorsMap.get("Cards").get("Cards_CCR_CardDetais_settlementAcct"), false);
//break;
